      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-semibold text-gray-900">SmartQuitIoT</span>
            </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start gap-2 text-gray-600">
                ...
                <span>123 Health Street, Wellness City,<br/>WC 12345</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-green-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm text-center md:text-left">
            © 2025 SmartQuitIoT. All rights reserved. Made with <span className="text-red-500">Hai Linh ❤</span> for a healthier world.
          </p>
          <div className="flex gap-4">
            {socialIcons.map((social, index) => (
              <a
                key={index}
                href="#"
                className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-gray-600 hover:text-green-600 hover:bg-green-50 transition-all shadow-sm hover:shadow-md"
